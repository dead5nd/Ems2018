...
(function ()
{
	...
	cd.kaijo = {
		1:[
			{ cd: "H", name:"本　学 - 生涯教育研修センター１号館"},
			{ cd: "N", name:"名古屋 - ウインクあいち"},
			{ cd: "T", name:"東　京 - TKP市ヶ谷カンファレンスセンター"},
			{ cd: "O", name:"大　阪 - 新梅田研修センター"},
			{ cd: "D", name:"センター - 大学入試センター"}
		],
		2:[
			{ cd: "H", name:"本学"},
			{ cd: "N", name:"名古屋 - ウインクあいち"},
			{ cd: "T", name:"東京 - TKP市ヶ谷カンファレンスセンター"},
			{ cd: "K", name:"金沢 - ホテル金沢"},
			{ cd: "S", name:"浜松 - ホテルクラウンパレス浜松"},
			{ cd: "Y", name:"四日市 - 四日市都ホテル"},
			{ cd: "O", name:"大阪 - CIVI研修センター　新大阪東"},
			{ cd: "D", name:"センター - 大学入試センター"},
			{ cd: "P", name:"センター本学 ‐入試センター＆本学"}
		],
		3:[
			{ cd: "H", name:"本校"}
		]
