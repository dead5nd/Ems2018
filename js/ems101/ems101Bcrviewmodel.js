...
(function()
{
   ...
   */
	...
	{
		//医療科学部のみ学籍書類OKを選択肢に表示する
		if (Login.gakubuCd == stngcode.IRYOKAGAKU) {
			$("#uketuke_stat").append($('<option>').html("学籍書類OK").val("4"));
			$("#uketuke_stat").append($('<option>').html("学籍書類OK取消").val("9"));
		}
   ...
   */
	...
	Ems101BcrViewModel.addList = function(list)
	{
		...
		if (list[0]['c6']==cd.uketukeOK) {
			obj['uketuke'] = 'ＯＫ';
		} else if ((list[0]['c6']==cd.uketukeNG)) {
			obj['uketuke'] = '不備';
		} else {
			obj['uketuke'] = '学籍書類OK';
		}
